<template>
  <div v-if="isOpen" class="fixed  inset-0 z-[60] flex justify-end pointer-events-none">
    ...
    <!-- Panel -->
    <div class="relative w-full sm:max-w-md h-full bg-white dark:bg-gray-900 shadow-2xl pointer-events-auto flex flex-col transform transition-transform duration-300"
